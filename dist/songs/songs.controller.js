...
const create_songs_dto_1 = require("./dto/create-songs-dto");
...
let SongsController = class SongsController {
    ...
    async create(createSongsDto, req) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_songs_dto_1.CreateSongsDto, Object]),
...
__decorate([
    (0, common_1.Get)('together'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], SongsController.prototype, "together", null);
__decorate([
    (0, common_1.Get)(':id'),
    __param(0, (0, common_1.Param)('id', new common_1.ParseIntPipe({ errorHttpStatusCode: common_1.HttpStatus.FORBIDDEN }))),
    __metadata("design:type", Function),
