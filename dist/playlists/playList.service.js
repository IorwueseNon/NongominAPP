...
let PlayListsService = class PlayListsService {
    ...
    async create(playListDTO) {
        const playList = new playlists_entitiy_1.Playlist();
...
exports.PlayListsService = PlayListsService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(playlists_entitiy_1.Playlist)),
    __param(1, (0, typeorm_1.InjectRepository)(songs_entitry_1.Song)),
